...
public final class ActivityGetStartedBinding implements ViewBinding {
  ...
  private ActivityGetStartedBinding(@NonNull LinearLayout rootView, @NonNull Button mBtnSignIn,
      @NonNull Button mBtnSignUp) {
  ...
  public static ActivityGetStartedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGetStartedBinding((LinearLayout) rootView, mBtnSignIn, mBtnSignUp);
    }
